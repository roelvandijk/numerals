...
module Text.Numeral.Language.OJI.TestData (cardinals) where
...
cardinals =
  [ ( "default"
    ...
    , [ (0, "kaagego")
      ...
      , (100, "ngodwaak")
      , (101, "ngodwaak shaa bezhik")
      , (102, "ngodwaak shaa niizh")
      , (103, "ngodwaak shaa nswi")
      , (104, "ngodwaak shaa niiwin")
      , (105, "ngodwaak shaa naanan")
      , (106, "ngodwaak shaa ngodwaaswi")
      , (107, "ngodwaak shaa niizhwaaswi")
      , (108, "ngodwaak shaa nshwaaswi")
      , (109, "ngodwaak shaa zhaangswi")
      , (110, "ngodwaak shaa mdaaswi")
      , (123, "ngodwaak shaa niizhtaana shaa nswi")
      , (200, "niizhwaak")
      , (300, "nswaak")
      , (321, "nswaak shaa niizhtaana shaa bezhik")
      , (400, "niiwaak")
      ...
      , (800, "nshwaaswaak")
      , (900, "zhaangswaak")
      , (909, "zhaangswaak shaa zhaangswi")
      , (990, "zhaangswaak shaa zhaangsmitaana")
      , (999, "zhaangswaak shaa zhaangsmitaana shaa zhaangswi")
      , (1000, "mdaaswaak")
      , (1001, "mdaaswaak shaa bezhik")
      , (1008, "mdaaswaak shaa nshwaaswi")
      , (1222, "mdaaswaak shaa niizhwaak shaa niizhtaana shaa niizh")
      , (1234, "mdaaswaak shaa niizhwaak shaa nsimtaana shaa niiwin")
      ]
    )
  ]
